...
# Formers
parser.add_argument('--enc_in', type=int, default=862, help='encoder input size') # DLinear with --individual, use this hyperparameter as the number of channels
...
parser.add_argument('--my_loss', type=str, default='Ordinal_CrossEntropy_Loss', help='custom loss')
...
#sigma
parser.add_argument('--sigma', type=float, default=0.015, help='sigma value for HLGaussLossFromSupport')

#num_bins
parser.add_argument('--num_bins', type=int, default=45, help='number of bins for soft label')
...
if args.is_training:
    for ii in range(args.itr):
        ...
        setting = '{}_{}_{}_ft{}_sl{}_pl{}_sigma{}_bins{}_loss{}_{}_{}'.format(
            args.model_id,
            args.model,
            args.data,
            args.features,
    ...
    ii = 0
    setting = '{}_{}_{}_ft{}_sl{}_pl{}_sigma{}_bins{}_loss{}_{}_{}'.format(args.model_id,
                                                                args.model,
                                                                args.data,
                                                                args.features,
                                                                args.seq_len,
